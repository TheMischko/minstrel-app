...
export class Logger {
	...
	public static error(message: string, ...meta: any[]): void {
		...
		Logger.instance._logger.error(message, meta);
	}

	public static warn(message: string, ...meta: any[]): void {
		Logger.initSingleton();
		Logger.instance._logger.warn(message, meta);
	}

	public static info(message: string, ...meta: any[]): void {
		Logger.initSingleton();
		Logger.instance._logger.info(message, meta);
	}

	public static http(message: string, ...meta: any[]): void {
		Logger.initSingleton();
		Logger.instance._logger.http(message, meta);
	}

	public static verbose(message: string, ...meta: any[]): void {
		Logger.initSingleton();
		Logger.instance._logger.verbose(message, meta);
	}

	public static debug(message: string, ...meta: any[]): void {
		Logger.initSingleton();
		Logger.instance._logger.debug(message, meta);
	}

	public static silly(message: string, ...meta: any[]): void {
		Logger.initSingleton();
		Logger.instance._logger.silly(message, meta);
	}
